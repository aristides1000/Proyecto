...
define("SERVIDOR", "http://localhost/Proyecto");/*mi ruta a la carpeta proyecto, tengo que estar muy pilas con esto al momento de montar mi carpeta en otra compu OJO OJO OJO OJO OJO OJO OJO sobre todo con el puerto de localhost que por defecto es 80, eso me va generar un error si no estoy pilas OJO*/
